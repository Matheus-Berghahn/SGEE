  ...
  return (
    <div className="flex flex-col w-[20%] min-h-screen h-full bg-color1 text-color-txt-2 fixed z-10 top-0 left-0">
      <div className="flex flex-col items-center py-6">
        ...
        <p className="text-sm text-color-txt-2">email@empresa.com</p>
      </div>
      ...
      <div className="flex flex-col mt-14 gap-10 pl-5 py-5 flex-grow">
        ...
        <Link href="/configuracoes" >
          <div className={`flex items-center text-xl px-4 pt-2 cursor-pointer pb-2 ${isActive('/configuracoes') ? 'bg-color2 text-color1 h-16 rounded-l-2xl' : ''}`}>
