    ...
    <div className="flex justify-center items-center w-full h-full bg-color1">
      ...
      <div className="flex-1 p-6">
        ...
        <div className="flex gap-6 mb-6">
          <div className="card w-1/4 bg-color4 rounded-lg p-16 relative shadow-xl  border-2 border-color1">
          ...
          <div className="card w-1/4 bg-color4 rounded-lg p-16 shadow-xl  relative border-2 border-color1">
          ...
          <div className="card w-2/4 bg-color2 rounded-lg p-16 shadow-xl  relative border-2 border-color1">
            <p className="text-7xl font-bold text-center text-color-txt-2">25/09/2024</p>
        ...
        <div className="bg-color4 rounded-lg p-6 shadow-lg  mb-6 border-2 border-color1">
          <div className="flex gap-6">
            <div className="card flex-1 text-center border-2 border-color2 w-1/5 rounded-lg bg-color2">
